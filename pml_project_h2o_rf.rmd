...
suppressMessages(library(h2o))         # Machine learning

## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Initiate and Connect to a Local H2O Cluster
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
localH2O <- h2o.init(max_mem_size = '12g') ## using a max 12GB of RAM
...
trainTransformedClasse <- as.data.frame(training[, length(training)])
testTransformedClasse <- as.data.frame(testing[, length(testing)])

## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Send processed dataframes to H2O for modeling
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
trainTransformed.hex <- as.h2o(localH2O, trainTransformed,
                               key = 'trainTransformed.hex')
testTransformed.hex <- as.h2o(localH2O, testTransformed,
                               key = 'testTransformed.hex')
validateTransformed.hex <- as.h2o(localH2O, validateTransformed,
                               key = 'validateTransformed.hex')

trainTransformedClasse.hex <- as.h2o(localH2O, trainTransformedClasse[,1],
                               key = 'trainTransformedClasse.hex')
testTransformedClasse.hex <- as.h2o(localH2O, testTransformedClasse,
                               key = 'testTransformedClasse.hex')
...
model.hex <- h2o.randomForest(x = trainTransformed.hex,
                              y = trainTransformedClasse.hex,
                              data = trainTransformed.hex,
                              classification = TRUE,
                              ntree = 1000,
                              mtries = 5,
                              nfolds = 10,
