...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Normalize data and decode class labels to prepare data for
## neural net training.
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
trainTransformedNorm <- normTrainingAndTestSet(trainTransformed)
testTransformedNorm <- normTrainingAndTestSet(testTransformed)
validateTransformedNorm <- normTrainingAndTestSet(validateTransformed)

trainTransformedClasseDecode <- decodeClassLabels(trainTransformedClasse)
testTransformedClasseDecode <- decodeClassLabels(testTransformedClasse)
...
model <- mlp(x = as.matrix(trainTransformed)
             ,y = (trainTransformedClasseDecode)
             ,size = c(10, 10)
             ,inputsTest = testTransformed
             ,targetsTest = testTransformedClasseDecode)
